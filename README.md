...
- You can register an event handler within the [oc.events](https://github.com/opentable/oc/wiki/Browser-client#oceventsoneventname-callback) system for the the `oc:mounted` event. The event will be fired immediately after the react app is mounted.
### externals
